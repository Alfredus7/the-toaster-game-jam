Shader "Toon/ToonOutline"
{
    ...
    SubShader
    {
        Tags { 
            ...
            "UniversalMaterialType" = "Unlit"  // Changed to Unlit
        }
        LOD 300

        // Main forward lit pass (copied from ToonBase instead of UsePass)
        Pass
        {
            Name "ForwardLit"
        ...
        // ShadowCaster pass (copied from URP Simple Lit)
        Pass
        {
            Name "ShadowCaster"
    ...
    // Changed fallback to avoid keyword conflicts
